...
void ticket_form_init(GtkWidget *stack) {
    ...
    // Fill structure
    ticket_form_page.page_label= GTK_WIDGET(gtk_builder_get_object(builder, "entry_username"));
    ticket_form_page.entry_password = GTK_WIDGET(gtk_builder_get_object(builder, "entry_password"));
    ticket_form_page.login_label = GTK_WIDGET(gtk_builder_get_object(builder, "login_label"));
